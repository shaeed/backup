...
// -----------------------------------------------------------------------------
   ...
   #define MAX6675_SCK_PIN	10
...
#elif defined(NODEMCU_4)

    // Relay provider light/my92XX
    #define MANUFACTURER            "ElecTree"
    #define DEVICE                  "NodeMCU 4"
    ...
    #define BUTTON2_MODE        BUTTON_PUSHBUTTON | BUTTON_DEFAULT_HIGH
    #define BUTTON2_RELAY       2
    #define BUTTON2_LNGLNGCLICK BUTTON_MODE_TOGGLE
    #define BUTTON2_LNGCLICK    BUTTON_MODE_TOGGLE

    #define BUTTON3_PIN         12
    #define BUTTON3_MODE        BUTTON_PUSHBUTTON | BUTTON_DEFAULT_HIGH
    #define BUTTON3_RELAY       3
    #define BUTTON3_LNGLNGCLICK BUTTON_MODE_TOGGLE
    #define BUTTON3_LNGCLICK    BUTTON_MODE_TOGGLE

    #define BUTTON4_PIN         13
    #define BUTTON4_MODE        BUTTON_PUSHBUTTON | BUTTON_DEFAULT_HIGH
    #define BUTTON4_RELAY       4
    #define BUTTON4_LNGLNGCLICK BUTTON_MODE_TOGGLE
    #define BUTTON4_LNGCLICK    BUTTON_MODE_TOGGLE
    ...
    #define LED2812B_PIN        15
    #define LED2812B_NUM        4
